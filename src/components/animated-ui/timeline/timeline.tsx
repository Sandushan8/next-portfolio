  ...
  return (
    <div className="w-full bg-black font-sans" ref={containerRef}>
      <div className="mx-auto py-20">
        <h2 className="mb-4 max-w-4xl text-center text-[30px] text-white md:text-left md:text-4xl">
          Experience
        </h2>
        <p className="max-w-xl text-[18px] text-white md:pt-10 md:text-[20px]">
          I've been working as a full-stack developer for the past 2 years.
          ...
          >
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              <div className="absolute left-3 flex h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-black md:left-3">
                <div className="h-4 w-4 rounded-full border border-neutral-300 bg-neutral-200 p-2 dark:border-black dark:bg-neutral-800" />
              </div>
